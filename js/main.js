...
const checkVal = () => {
    ...
    if (age.value.length == 0 || (!gr1_t1.checked && !gr1_t2.checked && !gr1_t3.checked) || phoneno.value.length == 0 || patientgender.options[patientgender.selectedIndex].value == 0 || email.value.length == 0) {
        ...
        // // 
        // var add_html = "<section><div class='container'><table class='tbl-result' id='customers'><tbody><tr><th>Tiêu đề</th><th>Giá trị</th></tr><tr><td>First Name</td><td class='value-fn'></td></tr><tr><td>Last Name</td><td class='value-ln'></td></tr><tr><td>Patient Age</td><td class='value-age'></td></tr><tr><td>Prefered Name / Nickname</td><td class='value-nickname'></td></tr><tr><td>Email</td><td class='value-email'></td></tr><tr><td>Patient Gender</td><td class='value-patient'></td></tr><tr><td>Phone no.</td><td class='value-phone'></td></tr><tr><td>Spouce Name</td><td class='value-spouce'></td></tr><tr><td>With whome do you live?</td><td class='value-whome'></td></tr><tr><td>Marital Status</td><td class='value-marital'></td></tr><tr><td>Occupation</td><td class='value-occupation'></td></tr><tr><td>Retired?</td><td class='value-retired'></td></tr><tr><td>Date of disability</td><td class='value-disability'></td></tr></tbody></table></div></section>";
        // document.querySelector('#sec_form').insertAdjacentHTML('afterend', add_html);
        // // 
        if (gr1_t3.checked) {
            if (otherstatus.value.length !== 0) {
